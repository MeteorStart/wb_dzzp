...
import com.kongqw.serialportlibrary.thread.SerialTempReadThread;
...
public class SerialTempPortManager extends SerialPort {

    private static final String TAG = SerialTempPortManager.class.getSimpleName();
    private DataInputStream mFileInputStream;
    ...
    private static SerialTempPortManager serialTempPortManager;


    private SerialTempReadThread mSerialPortReadThread;

    private SerialTempPortManager() {
    }

    public static SerialTempPortManager instance() {
        if (serialTempPortManager == null) {
            serialTempPortManager = new SerialTempPortManager();
        }
        return serialTempPortManager;
    }
    ...
    public boolean openSerialPort(File device, int baudRate) {
        ...
        try {
            ...
            mFileInputStream =new DataInputStream(new FileInputStream(mFd));
...
//        mOnSerialPortDataListener = null;
     ...
     */
    public SerialTempPortManager setOnOpenSerialPortListener(OnOpenSerialPortListener listener) {
     ...
     * @return SerialPortManager
     */
    public SerialTempPortManager setOnSerialPortDataListener(OnSerialPortDataListener listener) {
    ...
    private void startReadThread() {
        ...
        mSerialPortReadThread = new SerialTempReadThread(mFileInputStream) {
                @Override
    ...
    public SerialTempReadThread getmSerialPortReadThread() {
        return mSerialPortReadThread;
    }
