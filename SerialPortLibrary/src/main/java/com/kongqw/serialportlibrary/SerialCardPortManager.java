...
import com.kongqw.serialportlibrary.thread.SerialCardReadThread;
...
public class SerialCardPortManager extends SerialPort {

    private static final String TAG = SerialCardPortManager.class.getSimpleName();
    ...
    private SerialCardReadThread mSerialPortReadThread;

    private static SerialCardPortManager serialCardPortManager;

    private SerialCardPortManager(){}

    public static SerialCardPortManager instance(){
        if (serialCardPortManager == null) {
            serialCardPortManager = new SerialCardPortManager();
        }
        return serialCardPortManager;
    }
     ...
     */
    public SerialCardPortManager setOnOpenSerialPortListener(OnOpenSerialPortListener listener) {
     ...
     * @return SerialPortManager
     */
    public SerialCardPortManager setOnSerialPortDataListener(OnSerialPortDataListener listener) {
    ...
    private void startReadThread() {
        ...
        mSerialPortReadThread = new SerialCardReadThread(mFileInputStream) {
                @Override
